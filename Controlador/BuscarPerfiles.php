    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class='text-center'>
                <div style="background-color:#98e0b0;"><span
                        style="font-weight:bold"><?php echo  $estado_perfil;?></span></div>
            </td>

            <?php }else{ ?>

            <td class='text-center'>
                <div style="background-color:hsl(0, 84%, 80%);"><span style="font-weight:bold">Inactivo</span></div>
            </td>
            ...
            <td class='text-right'>
                ...
                <div class='text-rigth'>
                    <div class='btn-group'><button class='btn btn-info btnEditar' title='Editar categoría'
                            data-id='<?php echo $id_perfil;?>' data-login='<?php echo $login;?>'
                            data-password='<?php echo $password;?>' data-rol='<?php echo $rol;?>'
                            data-estado='<?php echo $estado_perfil;?>' data-toggle="modal" data-target="#mymodal2"> <i
                                class="glyphicon glyphicon-edit"></i>Editar</button>



                        <button class='btn btn-danger btnBorrar' title='Borrar categoría'
                            onclick="eliminarPerfil('<?php echo $id_perfil;?>')"><i
                                class="glyphicon glyphicon-trash"></i> Borrar</button>
                    </div>
                </div>
