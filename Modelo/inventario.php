...
class Inventarios
{
	...
	public function crearInventario($asignado,$nombre,$tipo,$marca,$modelo,$serial,$fabricante,$estado,$proveedor,$fechaIngreso,$fechaSalida)
	{
		$this->asignado=$asignado;
		$this->nombre=$nombre;
		$this->tipo=$tipo;
	...
	public function crearInventario2($idinventario,$asignado,$nombre,$tipo,$marca,$modelo,$serial,$fabricante,$estado,$proveedor,$fechaIngreso,$fechaSalida)
	{
		$this->idinventario=$idinventario;
		$this->asignado=$asignado;
		$this->nombre=$nombre;
	...
	public function agregarInventario()
	{
		...
		invproveedor,Fecha_Ingreso,Fecha_Salida) values ('$this->asignado','$this->nombre',
		'$this->tipo','$this->marca','$this->modelo','$this->serial','$this->fabricante','$this->estado',
		'$this->proveedor','$this->fechaIngreso','$this->fechaSalida')";
