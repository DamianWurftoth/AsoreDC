...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2021 a las 16:41:02
...
INSERT INTO `activos_tecnologicos` (`id_inventario`, `Asignado`, `Nombre`, `Tipo`, `Marca`, `Modelo`, `Serial`, `Fabricante`, `Estado`, `invproveedor`, `Fecha_Ingreso`, `Fecha_Salida`, `Seguimientos`) VALUES
(5, 3, 'Plástico', ' Desktop ', ' Apple ', '12', '1234', ' APPLE ', 'Activo', 1, '2021-05-01', '2021-05-04', NULL);
...
(6, 'AdminPerfiles', 'a88e3dfcdd89f5c93e22c5ee52e67746', 'Activo', 2),
(9, 'Uva', '797316d7d077df9962a7d76366e77fdc', 'Activo', 1);
...
INSERT INTO `proveedor` (`id_Proveedor`, `NIT`, `Nombre`, `Direccion`, `Telefono`) VALUES
(1, '12345', 'MULTIRESIDUOS', 'cll 72 # 14', '3456172');
...
CREATE TABLE `usuarios` (
  ...
  `ARP` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `EPS` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `usuarios` (`id_usuarios`, `Nombres`, `Apellidos`, `Cedula`, `Fecha_Nacimiento`, `ARP`, `EPS`, `Telefono`, `Direccion`, `Correo`) VALUES
(3, 'Mábel Briyid', 'Rodríguez', 1007719478, '2021-04-27', 'Sura', 'Sanitas', '3223710008', 'Av Caracas # 3 - 44', 'vet@gmail.com');
