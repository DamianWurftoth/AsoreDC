    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <div>
                    <a class="navbar-brand" href="../Vista/listaUsuarios.php"> <i class='glyphicon glyphicon-home'> </i>
                    </a>
                    <a href="../Vista/nosotros.html"> <img alt="" src="../Imagenes/logo_andromeda_reduc.PNG"></a>
                </div>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class=""><a href="../Vista/listaUsuarios.php"><i class='glyphicon glyphicon-user'></i>
                            Usuarios</a></li>
                    <li class=""><a href="../Vista/listaInventario.php"><i class='glyphicon glyphicon-tags'></i>
                            Inventario</a></li>
                    <li class=""><a href="../Vista/reportes.php"><i class='glyphicon glyphicon-file'></i> Reportes</a>
                    </li>
                    <?php if($_SESSION['rol']==2) { ?>
                    <li class=""><a href="../Vista/listaPerfiles.php"><i class='glyphicon glyphicon-cog'></i>
                            Perfiles</a></li>
                    <?php } ?>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span
                                class="glyphicon glyphicon-user" style="color:#FFFFFF"></span>
                            <?php echo $_SESSION['user']?><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="salir.php" onmouseover="mopen('m1')" onmouseout="mclosetime()"><i
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="caja_busqueda" id="caja_busqueda"
                                placeholder="Ingrese perfil" onkeyup='load(1);'>
                        </div>
                        <div class="col-md-3">
