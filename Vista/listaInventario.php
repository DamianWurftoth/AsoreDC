                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title">Material Cargado</h4>
                                    <p class="category">.</p>
                                </div>
                                <div class="card-content">
                                    <br>
                                    <?php if($_SESSION['rol']==1) { ?>
                                    <a href="../Vista/RegistrodeInventario.php" target="_self"><button
                                            title="Registrar Activo" type="button" class="btn btn-primary"><span
                                                class="icon-plus"></span> <span
                                                class="icon-dropbox"></span></button></a><?php } ?>
                                    <br>
                                    <?php
  if ($msj==1)
