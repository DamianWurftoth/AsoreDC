            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Crear Reciclador </a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title">Agregar Reciclador</h4>
                                    <p class="category">.</p>
                                </div>
                                <div class="card-content">
                                    ...
                                    <br>
                                    <br>
                                    <form class="form-horizontal" action="../Controlador/validarInsertarUsuario.php"
                                        method="post">
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <input style="width:30%" type="text" class="form-control" id="Nombres"
                                                    name="Nombres" placeholder="Ingrese los nombres del usuario"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input style="width:30%" type="text" class="form-control" id="Apellidos"
                                                    name="Apellidos" placeholder="Ingrese los apellidos del usuario"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="Fecha de Nacimiento">Fecha de
                                                    Nacimiento: </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="width:30%" type="text" class="form-control" id="ARP"
                                                    name="ARP" placeholder="Ingrese la ARP del usuario" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="EPS">EPS: </label>
                                                <input style="width:30%" type="text" class="form-control" id="EPS"
                                                    name="EPS" placeholder="Ingrese la EPS del usuario" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input style="width:30%" type="text" class="form-control" id="Telefono"
                                                    name="Telefono" placeholder="Ingrese el Teléfono del usuario"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input style="width:30%" type="text" class="form-control" id="Direccion"
                                                    name="Direccion" placeholder="Ingrese la Dirección del usuario"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="Correo">Correo: </label>
                                                <input style="width:30%" type="txt" class="form-control" id="Correo"
                                                    name="Correo"
                                                    placeholder="Ingrese el correo corporativo del usuario" required>
                                            </div>
                                            <br>
                                            <br>
                                            <div align="middle">
