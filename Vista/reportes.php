                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="../Vista/listaInventario.php" target="_self"><button title="Ver Inventario"
                                            ...
                                            <span class="icon-archive"></span></button></a><?php } ?>
                                    <a href="../Controlador/MasivoInventario.php" target="_self"><button
                                            title="Descargar Masivo" type="button" class="btn btn-primary"><span
                                                class="icon-download"></span></button></a>
                                    <br>
                                    <br>
                                    <br>
                                    <form class="form-horizontal" action="../Controlador/GenerarReporte.php"
                                        method="post">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="asignado">Usuario: </label>
                                            <select style="width:30%" id="asignado" name="asignado"
                                                class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width:30%" class="form-control" id="estado" name="estado">
                                                <option value="">Seleccione</option>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4"
                                                for="exampleFormControlSelect1">Ingreso o Salida: </label>
                                            <select style="width:30%" class="form-control form-control-lg"
                                                id="ingresosalida" name="ingresosalida">
                                                <option value="">Seleccione</option>
                                        ...
                                        <div style="left:25%" class="form-group col-md-3">
                                            <label class="control-label col-sm-4" for="Fecha Ingreso">Desde:</label>
                                            <input type="date" class="form-control" id="desde" name="desde">
                                        </div>

                                        <div style="left:30%" class="form-group col-md-3">
                                            <label class="control-label col-sm-4" for="Fecha Salida">Hasta:</label>
                                        ...
                                        <div align="middle">
                                            <button type="submit" class="btn btn-primary btn-lg"
                                                name="generar_reporte">Descargar</button>
